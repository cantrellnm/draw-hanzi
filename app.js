...
app.get('/account/lists', passportConfig.isAuthenticated, listController.getLists);
app.get('/account/lists/new', passportConfig.isAuthenticated, listController.newList);
app.post('/account/lists/new', passportConfig.isAuthenticated, listController.createList);
app.get('/account/list/:id', passportConfig.isAuthenticated, listController.viewList);
app.get('/account/list/:id/edit', passportConfig.isAuthenticated, listController.editList);
app.post('/account/list/:id/edit', passportConfig.isAuthenticated, listController.updateList);
app.post('/account/list/:id/delete', passportConfig.isAuthenticated, listController.deleteList);
